...
/* V7 -- Inherited from V6 -- 1. Removing base10Exp for servo data.
                              2. Adding 'Time read' for each servo. */
...
//----------------TIME-(MILLISECONDS)-RELATED----------------//
  ...
  for(module=0; module<4; module++)
  {
    ...
    predictedAngle = (theta_0 + (rawData[module] * theta_1)) - 90;
    ...
    String dataString;
    dataString = dataString + longServoData + '/' + int(time_main - time_individualServo_read[module]);
